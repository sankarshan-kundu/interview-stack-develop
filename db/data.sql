...
;
INSERT INTO `Product`
VALUES (1, 'Hat', '/assets/images/hat.jpg', 'Active'),
  (2, 'Shoes', '/assets/images/shoe.jpg', 'Active'),
  (3, 'Pants', '/assets/images/pants.jpg', 'Active'),
  (
    4,
    'Shirt',
  ...
  (5, 'Coat', '/assets/images/coat.jpg', 'InActive');
